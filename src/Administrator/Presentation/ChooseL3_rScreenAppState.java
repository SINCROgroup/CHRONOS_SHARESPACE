...
public class ChooseL3_rScreenAppState extends AbstractAppState implements ScreenController {
    private static final Logger logger = Logger.getLogger(ChooseL3_rScreenAppState.class.getName());
    ...
    public ChooseL3_rScreenAppState(SimpleApplication app,String name) {
    ...
    private void setUpView() {
        ...
        if (Settings.getSettings().getCount() == 1) {
            l.setText("Set the features of the 2nd L3 substitute");
        } else if (Settings.getSettings().getCount() == 2) {
            l.setText("Set the features of the 3rd L3 substitute");
        } else if (Settings.getSettings().getCount() >= 3) {
            int var10001 = Settings.getSettings().getCount();
            l.setText("Set the features of the " + (var10001 + 1) + "th L3 substitute");
        }
        ...
        SetList(this.controller,(Paths.get("src\\Administrator\\Algorithm\\L3_r")).toString());
        //this.controller.addItem("deep Q network");
        System.out.println((Paths.get("src\\Administrator\\Algorithm\\L3_r")).toAbsolutePath().toString());
    }
    ...
    public void setVP() {
        ...
        Settings.getSettings().setL3_s_inner_d(d,Integer.parseInt(textFieldNumPlayer.getRealText()));
        Settings.getSettings().setL3_s_algorithm(c,Integer.parseInt(textFieldNumPlayer.getRealText()));
        Settings.getSettings().setL3_r_role(r,Integer.parseInt(textFieldNumPlayer.getRealText()));
        ...
        if (Settings.getSettings().getNumL3_r() == Settings.getSettings().getCount()) {
            Settings.getSettings().setCount(0);
            logger.info("Settings of L3_s is completed.");
            ...
            ChooseL3_rScreenAppState vpController = new ChooseL3_rScreenAppState(this.app,this.name);
    ...
    public void update(float tpf) {
        ...
        if(!Objects.equals(c, Prevc)){
            ...
            try{
                ...
                clazz = Class.forName("Administrator.Algorithm.L3_r."+c);
