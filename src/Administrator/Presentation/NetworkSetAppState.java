...
public class NetworkSetAppState extends AbstractAppState implements ScreenController{
    ...
    //costruttore
    public NetworkSetAppState(SimpleApplication app){
    ...
    public void OnlyHumansMethod(String nextScreen) {

            SoloHumansAppState chooseController = new SoloHumansAppState(app);
            nifty.fromXml("Interface/SoloHumansInterface.xml", "SoloHumans", chooseController);
            app.getStateManager().attach(chooseController);
            nifty.gotoScreen(nextScreen);

    }
    public void WithVirtualAgentsMethod(String nextScreen) {

        WithVirtualAgentsAppState chooseController = new WithVirtualAgentsAppState(app);
        nifty.fromXml("Interface/WithVirtualAgentsInterface.xml", "WithVirtualAgents", chooseController);
        app.getStateManager().attach(chooseController);
        nifty.gotoScreen(nextScreen);
    ...
    public void setNetwork(String nexWithVirtualAgentsMethod(een){
    ...
    public void quitMethod(String nextScreen){
